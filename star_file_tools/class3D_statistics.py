...
def plot_data(input_dict):
    ...
    axs[0].grid(b=True, which='major', color='gray', linestyle='-', alpha=0.5)
    axs[0].grid(b=True, which='minor', color='gray', linestyle='--', alpha=0.2)
    axs[1].grid(b=True, which='major', color='gray', linestyle='-', alpha=0.5)
    axs[1].grid(b=True, which='minor', color='gray', linestyle='--', alpha=0.2)
