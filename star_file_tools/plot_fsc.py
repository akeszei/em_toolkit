...
def parse_star_file(file):
    """ For a given postprocess.star file, parse the FSC data into a list of tuples:
                [
                    ( inverse_resolution,  Ang_resolution,  FSC_corr,  FSC_unmasked,  FSC_masked),
                    ...
                ]
    """
    ...
    with open(file, 'r') as f :
        ...
        for line in f :
            ...
            if (inv_res_col > 0) and (ang_res_col > 0) and (fsc_corr_col > 0) and (fsc_unmask_col > 0) and (fsc_mask_col > 0):
...
def plot_data(data):
    ...
    for i in range(len(data)):
        ...
        inverse_resolution,  Ang_resolution,  FSC_corr,  FSC_unmasked,  FSC_masked = data[i]
