...
def get_tiltgroup_from_fname(fname):
    filename_to_list = fname.split("_") ## REF: https://forum.scilifelab.se/t/creating-optics-groups-from-epu-afis-data-and-more/122/7
                                        ## FoilHole_<x>_Data_<y>_<tiltgroup>_<d>_<t>_EER.eer
    ...
    tiltgroup_value = filename_to_list[idx_position_of_data + relative_idx_position_from_data_to_tiltgrp]

    return tiltgroup_value
...
def find_all_tiltgroups(fileList):
    ...
    for file in fileList:
        ...
        tilt_id = get_tiltgroup_from_fname(file)
...
def classify_images_into_tiltgroups(tiltgroupList, fileList):
    ...
    for file in fileList:
        ...
        file_tilt_id = get_tiltgroup_from_fname(file)
