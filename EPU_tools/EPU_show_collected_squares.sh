...
## This script is meant to be run in an EPU directory (i.e. containing Images-Disc folder) while pointing to the correct Atlas.mrc file. It will run through all GridSquares folders and try to map their positions into the Atlas with red squares
## Usage: EPU_show_collected_suqares.sh Atlas_1.mrc 
...
echo " Check for atlas file = $atlas_file"
